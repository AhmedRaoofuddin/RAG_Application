...
def upgrade() -> None:
    ...
    # document_id column is added here for SQLite compatibility (normally added in migration 59cfa0f1361d)
    op.create_table(
        'document_chunks',
        sa.Column('id', sa.String(64), nullable=False),
        sa.Column('kb_id', sa.Integer(), nullable=False),
        sa.Column('document_id', sa.Integer(), nullable=False),  # Added for SQLite
        sa.Column('file_name', sa.String(255), nullable=False),
        sa.Column('chunk_metadata', sa.JSON(), nullable=True),  # Renamed from metadata for consistency
