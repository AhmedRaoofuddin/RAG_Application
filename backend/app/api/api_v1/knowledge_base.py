...
async def delete_knowledge_base(
    *,
    ...
    try:
        ...
        # 1. Clean up local files (replaces MinIO)
        try:
            ...
            if kb_dir.exists():
                ...
                logger.info(f"Cleaned up local files for knowledge base {kb_id}")
        except Exception as e:
            cleanup_errors.append(f"Failed to clean up local files: {str(e)}")
...
async def cleanup_temp_files(
    ...
    # Clean up local files (replaces MinIO)
