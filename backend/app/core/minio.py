...
def init_minio():
    ...
    MinIO is optional - if not available, log warning and continue.
    """
    try:
        ...
        logger.warning(f"⚠️  MinIO not available: {e}. Continuing without object storage. Documents will be stored in local filesystem.")
        # Don't raise - MinIO is optional for local development
        pass
