...
class KnowledgeBase(Base, TimestampMixin):
    ...
    description = Column(Text)  # TEXT works for both SQLite and MySQL
...
class DocumentUpload(Base):
    ...
    created_at = Column(DateTime, nullable=False, default=datetime.utcnow)  # Use Python default for SQLite compatibility
