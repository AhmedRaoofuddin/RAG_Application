# Fortes Eduction - Makefile for easy command execution

.PHONY: help dev backend frontend test eval ingest clean

help:
	@echo "Fortes Eduction - Available Commands"
	@echo "===================================="
	@echo ""
...
dev:
	@echo "Starting Fortes Eduction in development mode..."
...
frontend:
	@echo "Starting Fortes Eduction Frontend..."
	cd frontend && npm run dev

test:
	@echo "Running Fortes Eduction Tests..."
